...
public class PreferenceActivity extends ToolbarActivity implements SearchPreferenceResultListener {
    ...
    public static final String OPEN_AUTOMATIC_BACKUP = "OpenAutomaticBackup";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getBooleanExtra(OPEN_AUTOMATIC_BACKUP, false)) {
            openScreen(R.xml.preferences_import_export);
        }
    }
